...
describe('CommunicationState', () => {
  let senderContainer: Container;
  let receiverContainer: Container;

  beforeEach(() => {
    senderContainer = new UnitTestContainer().create({
      privateKey:
    ...
    receiverContainer = new UnitTestContainer().create({
      privateKey:
  ...
  it('should be able to communicate correctly', async () => {
